...
> **⚠ 尚待 lead 裁決之 6 題**：`OQ-D9-28`～`OQ-D9-33`（對應 AC 已標 `[ASSUMPTION]`）。其中 **`OQ-D9-32` 影響 #2 之安全目標是否真正達成**（`/public/documents/:id/pdf` 若維持 RAW，Network 面板仍可取得未燒錄原件）、**`OQ-D9-31` 影響浮水印可讀性代價**（`opacity` 0.12→0.57）。
