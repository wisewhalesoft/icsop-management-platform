# F042: OJT 進度管理
Priority: P1 | Status: 🟢 **規格定稿（2026-08-28 人類閘門對 `OQ-E11-01`～`OQ-E11-16` 全數裁決）；Phase A+B 完成並提交，另含 2026-08-28 實機修正兩輪與 2026-09-01 TAB2 文件分組模式一輪（[`OQ-E11-21`](../open-questions.md#e11-post-impl)）** | Last Updated: 2026-09-01
...
| ↳ 組內之 `[data-progress-row="{documentId}__{orgCode}"]` | 🔒 **既有掛鉤與其全部子掛鉤、全部行為一格不改**（展開／新增／下載／刪除、角色守門、孤兒列規則）；組內依 `orgName` 昇冪 | `AC-31` ④／`AC-34` |
