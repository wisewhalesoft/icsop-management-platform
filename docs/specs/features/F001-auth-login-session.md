...
Priority: P0-MVP | Status: Draft（途徑 A 端到端驗證；途徑 B 帳密登入已實作＋單元驗證，識別鍵＝loginId） | Last Updated: 2026-07-23
