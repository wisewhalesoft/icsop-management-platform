 ...
 *
 * 🔴 UX16 delta 互指（2026-09-22）：本區塊為 `AC-56` 之**後台正向半句**，一字不動
 * （[F043#ux16-delta](../../../docs/specs/features/F043-business-function-category.md#ux16-delta)
 * `AC-UX27` ②）。其**前台對應之正向半句**現由 `PublicCategoryTreePage.test.tsx` 之
 * `AC-UX14` 承接（前台 `30` 之負向鎖已由 `AC-UX14` 反轉為正向，原「前台刻意沒有導向鈕」之
 * `AC-56` 前台負向半句已作廢，見 `AC-UX27` ①）。🔒 兩邊互指是本 repo 讓「成對斷言」不會被
 * 單邊拆掉的唯一手段——任一邊被動手腳，從另一邊看得出來。
 *
